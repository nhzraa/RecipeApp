...
public class AllRecipes extends AppCompatActivity {
    ...
    private class DoAll extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(AllRecipes.this, "Synchronising",
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                if (conn == null) {
                    ...
                    String query="select * from recipes order by title asc LIMIT 1000";
        ...
        protected void onPostExecute(String z) {
            ...
            Toast.makeText(AllRecipes.this, z + "", Toast.LENGTH_LONG).show();

            if(isSuccess == true)
            {
                try
                {
                    myAppAdapter = new MyAppAdapter(recipeArrayList , AllRecipes.this);
