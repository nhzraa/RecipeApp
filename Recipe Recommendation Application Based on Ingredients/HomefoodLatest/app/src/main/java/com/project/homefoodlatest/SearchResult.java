...
//
        ...
        String ingre1str = intent.getStringExtra("ing1");
        String ingre2str = intent.getStringExtra("ing2");
        String ingre3str = intent.getStringExtra("ing3");

        @Override
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(SearchResult.this, "Searching...",
                    "Ingredients Are Being Matched! Please Wait!", true);
//            super.onPreExecute();
        }
...
//                z = "Please enter the required field!";
//            else
//            {
            try {
                ...
                if (conn == null) {
                    ...
                    String query="select * from recipes where ingredients like '%"+ingre1str+"%' or '%"+ingre2str+"%' or '%"+ingre3str+"%'";
...
//            }
        ...
        protected void onPostExecute(String z) {
            ...
            Toast.makeText(SearchResult.this, z + "", Toast.LENGTH_LONG).show();

            if(isSuccess == true)
            {
                try
                {
                    myAppAdapter = new MyAppAdapter(recipeArrayList , SearchResult.this);
...
//                tvCalories = (TextView) v.findViewById(R.id.tvCalories);
        ...
        public MyAppAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            View v = inflater.inflate(R.layout.searchresult_layout, parent, false);
