...
public class test extends AppCompatActivity {
    ...
    private static final String DB_URL = "jdbc:mysql://172.20.10.2:3310/recipe_app"; //"jdbc:mysql://DATABASE_IP/DATABASE_NAME";
    ...
    private class DoAll extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(test.this, "Synchronising",
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                if (conn == null) {
                    ...
                    String query="select * from recipes where ingredients like '%chicken%' or '%pasta%' or '%tomato%' order by rand() limit 1";
        ...
        protected void onPostExecute(String z) {
            ...
            Toast.makeText(test.this, z + "", Toast.LENGTH_LONG).show();

            if(isSuccess == true)
            {
                try
                {
                    myAppAdapter = new MyAppAdapter(recipeArrayList , test.this);
...
//                tvCalories = (TextView) v.findViewById(R.id.tvCalories);
        ...
        public MyAppAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            ...
            View v = inflater.inflate(R.layout.allrecipes_layout, parent, false);
